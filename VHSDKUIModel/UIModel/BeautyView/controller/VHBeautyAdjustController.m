...
- (void)setupContentView{
    ...
    [self.contentView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.offset(0);
        make.width.mas_equalTo(VH_KScreenIsLandscape?kAdaptScale*292:VHScreenWidth);
        if (VH_KScreenIsLandscape) {
            make.top.offset(0);
        }else{
            make.left.offset(0);
...
- (void)setupTopView{
    ...
    UIImageView *resetIcon = [[UIImageView alloc] initWithImage:BundleUIImage(@"clockwiserotation")];
...
- (void)setupSliderView{
    ...
    [self.sliderView setThumbImage:BundleUIImage(@"full-brush") forState:UIControlStateNormal];
    [self.sliderView setThumbImage:BundleUIImage(@"full-brush") forState:UIControlStateHighlighted];;
...
//    self.collectionView.backgroundColor = UIColor.yellowColor;
    ...
    [self.collectionView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.offset(0);
        make.right.offset(0);
        //make.top.mas_equalTo(self.sliderView.mas_bottom).offset(kAdaptScale *14);
