...
UIInterfaceOrientation ITTInterfaceOrientationUIModel() {
    UIInterfaceOrientation orient = [UIApplication sharedApplication].statusBarOrientation;
    return orient;
}

CGRect ITTScreenBoundsUIModel() {
    CGRect bounds = [UIScreen mainScreen].bounds;
    if (UIInterfaceOrientationIsLandscape(ITTInterfaceOrientationUIModel())) {
...
@implementation UIView (ITTAdditionsUIModel)
...
- (CGFloat)orientationWidth {
    return UIInterfaceOrientationIsLandscape(ITTInterfaceOrientationUIModel())
