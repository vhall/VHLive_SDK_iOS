...
@interface VHInteractLiveBaseVC ()<VHLiveBroadcastInfoDetailViewDelegate,VHLiveDocContentViewDelegate,VHLiveStateViewDelegate,VHallChatDelegate,VHDocumentDelegate,VHEndPublisherVCDelegate,VHDocBrushPopViewDelegate>
