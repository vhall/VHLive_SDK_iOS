...
- (void)showLotteryResultWithVHLottery:(VHallLottery *)vhLottery endLotteryModel:(VHallEndLotteryModel *)endLotteryModel
{
    ...
    otherInfo[@"needTakeAward"] = @(endLotteryModel.huadieInfo.need_take_award);
    [VUITool sendTestsNotificationCenterWithKey:VHTests_Lottery_End_Result otherInfo:otherInfo];
...
- (UIButton *)nowPrizeBtn {
    if (!_nowPrizeBtn) {
        ...
        _nowPrizeBtn.accessibilityLabel = VHTests_Lottery_NowPrize;
...
- (UIButton *)checkBtn {
    if (!_checkBtn) {
        ...
        _checkBtn.accessibilityLabel = VHTests_Lottery_Check;
