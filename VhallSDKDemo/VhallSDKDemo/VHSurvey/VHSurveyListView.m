...
- (void)requestSurveyIsShow:(BOOL)isShow
{
    ...
    [self.vhSurvey fetchSurveyListWebinarId:self.webinarInfoData.webinar.data_id roomId:self.webinarInfoData.interact.room_id switchId:self.webinarInfoData.data_switch.switch_id success:^(VHSurveyListModel *listModel) {
