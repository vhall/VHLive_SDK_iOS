...
- (void)setupSliderView{
    ...
    UISlider *slider = [[UISlider alloc] initWithFrame:CGRectMake(Screen_Width/2 - 75, 0, 150, 20)];
...
- (void)setupBeautyTopView{
    ...
    UIButton *reset = [[UIButton alloc] initWithFrame:CGRectMake(Screen_Width - 80, 0, 30, 30)];
...
- (UIView *)contentView{
    if (!_contentView) {
        _contentView = [[UIView alloc] initWithFrame:CGRectMake(0, Screen_Height - VHBeautyViewHeight, Screen_Width, VHBeautyViewHeight)];
...
- (void)showDisplayBeautyView:(UIView *)view{
    ...
    [self.contentView setFrame:CGRectMake(0, Screen_Height, Screen_Width, VHBeautyViewHeight)];
    [UIView animateWithDuration:0.3 animations:^{
        self.alpha = 1.0;
        [self.contentView setFrame:CGRectMake(0, Screen_Height - VHBeautyViewHeight, Screen_Width, VHBeautyViewHeight)];
    } completion:nil];
}
- (void)disMissView{
    [self.contentView setFrame:CGRectMake(0, Screen_Height - VHBeautyViewHeight, Screen_Width, VHBeautyViewHeight)];
    [UIView animateWithDuration:0.3f animations:^{
        self.alpha = 0.0;
        [_contentView setFrame:CGRectMake(0, Screen_Height, Screen_Width, VHBeautyViewHeight)];
...
- (UIView *)sliderView{
    if (!_sliderView) {
        _sliderView = [[UIView alloc] initWithFrame:CGRectMake(0,40, Screen_Width, 40)];
...
- (void)setupProgressView{
    ...
    [self.progressView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.offset(Screen_Height - VHBeautyViewHeight - 40);
