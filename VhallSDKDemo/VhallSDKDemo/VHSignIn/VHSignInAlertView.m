...
- (void)startSign
{
    ...
    [VUITool sendTestsNotificationCenterWithKey:VHTests_SignIn otherInfo:otherInfo];
...
- (void)applyBtnAction:(UIButton *)sender
{
    ...
    [self.vhSign signSuccessIsStop:YES
                           success:^{
        // 解开限制
...
- (UIButton *)applyBtn {
    if (!_applyBtn) {
        ...
        _applyBtn.accessibilityLabel = VHTests_SignIn_Btn;
