...
- (void)requestGetRoomLikeWithRoomId
{
    ...
    [VHallLikeObject getRoomLikeWithRoomId:self.webinarInfoData.interact.room_id complete:^(NSInteger total, NSError *error) {
...
{
    __weak __typeof(self)weakSelf = self;
    [VHallLikeObject createUserLikeWithRoomId:self.webinarInfoData.interact.room_id num:self.likeTapCount complete:^(NSDictionary *responseObject, NSError *error) {
        VHLog(@"点赞成功");
