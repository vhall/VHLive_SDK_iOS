...
- (void)getRecordChaptersList
{
    ...
    [VHChaptersObject getRecordChaptersList:self.webinarInfoData.record.record_id
                                   complete:^(NSArray<VHChaptersItem *> *chaptersList, NSError *error) {
        if (chaptersList) {
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        _tableView.accessibilityIdentifier = VHTests_Back_RecordChapter;
